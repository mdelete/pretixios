...
public class KeychainService: NSObject {
    ...
    public class func savePassword(token: String, key: String) {
        self.save(service: key as NSString, data: token as NSString)
    }
    
    public class func deletePassword(key: String) {
        self.delete(service: key as NSString)
    }
    
    public class func loadPassword(key: String) -> String? {
        return self.load(service: key as NSString) as String?
    }
